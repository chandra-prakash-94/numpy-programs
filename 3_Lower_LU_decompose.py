'''
*  Assignment 3 : LU decomposition- Python Program to compute lower triangular matrix for given non-singular matrix
*  Regd No.     : 22-27-04
...
try:
    ...
    if np.linalg.det(a)!=0:        # if the matrix is non-singular matrix, then we compute upper triangular matrix
        ...
        print("Lower triangular Matrix for LU decomp is : ")
        print(L)
